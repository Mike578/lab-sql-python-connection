...
-- 2. Write a Python function called rentals_month that retrieves rental data 
-- for a given month and year (passed as parameters) from the Sakila database as a Pandas DataFrame. 
...
-- according to the month and year, for example, if the input month is 05 and the year is 2005, 
